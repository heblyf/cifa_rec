...
def main():
    ...
    parser.add_argument("--max_rating", default=5, type=int, help="maximum rating")
    parser.add_argument("--num_genres", default=18, type=int, help="number of genres")
    parser.add_argument("--num_user_gender", default=2, type=int, help="number of gender")
    parser.add_argument("--num_user_age", default=7, type=int, help="number of user age")
